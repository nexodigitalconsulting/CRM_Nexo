    ...
    <Page size="A4" style={commonStyles.page}>
      ...
      <View style={commonStyles.header}>
        <View>
          ...
          {props.companyCity && <Text style={commonStyles.companyInfo}>{props.companyCity}</Text>}
          {props.companyEmail && <Text style={commonStyles.companyInfo}>{props.companyEmail}</Text>}
        </View>
        <View style={commonStyles.documentInfo}>
          <Text style={commonStyles.documentNumber}>{props.contractNumber}</Text>
          {props.contractName && <Text style={commonStyles.documentDate}>{props.contractName}</Text>}
      ...
      <View style={commonStyles.datesRow}>
        <View style={commonStyles.dateItem}>
          <Text style={commonStyles.dateLabel}>Inicio:</Text>
          <Text style={commonStyles.dateValue}>{props.startDate}</Text>
        </View>
        <View style={commonStyles.dateItem}>
          <Text style={commonStyles.dateLabel}>Fin:</Text>
          <Text style={commonStyles.dateValue}>{props.endDate || 'Indefinido'}</Text>
        </View>
        <View style={commonStyles.dateItem}>
          <Text style={commonStyles.dateLabel}>Facturación:</Text>
          <Text style={commonStyles.dateValue}>{props.billingPeriod}</Text>
        </View>
      </View>
      ...
      <View style={commonStyles.clientSection}>
        ...
        {(props.clientCity || props.clientPostalCode) && (
          <Text style={commonStyles.clientDetail}>
            {[props.clientPostalCode, props.clientCity, props.clientProvince].filter(Boolean).join(', ')}
          </Text>
        )}
      ...
      {/* Services Table */}
      <Text style={commonStyles.sectionTitle}>Servicios Contratados</Text>
      ...
      {props.notes && (
        <View style={commonStyles.notesSection}>
          <Text style={commonStyles.notesTitle}>Términos y Condiciones</Text>
