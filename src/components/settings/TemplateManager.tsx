...
// Variables organizadas por entidad con TODAS las variables disponibles
const variablesByEntity: Record<string, Record<string, { label: string; dbVar: string; icon: React.ElementType }[]>> = {
  contract: {
    "Datos de Empresa": [
      ...
      { label: "Ciudad Empresa", dbVar: "company_city", icon: Building2 },
      { label: "Provincia Empresa", dbVar: "company_province", icon: Building2 },
      { label: "CP Empresa", dbVar: "company_postal_code", icon: Hash },
      { label: "Teléfono Empresa", dbVar: "company_phone", icon: User },
      { label: "Email Empresa", dbVar: "company_email", icon: User },
      { label: "Web Empresa", dbVar: "company_website", icon: Building2 },
      { label: "IBAN Empresa", dbVar: "company_iban", icon: Hash },
    ],
    "Datos del Cliente": [
      ...
      { label: "Ciudad Cliente", dbVar: "client_city", icon: Building2 },
      { label: "Provincia Cliente", dbVar: "client_province", icon: Building2 },
      { label: "CP Cliente", dbVar: "client_postal_code", icon: Hash },
      { label: "País Cliente", dbVar: "client_country", icon: Building2 },
      { label: "Email Cliente", dbVar: "client_email", icon: User },
      { label: "Teléfono Cliente", dbVar: "client_phone", icon: User },
      { label: "IBAN Cliente", dbVar: "client_iban", icon: Hash },
      { label: "Segmento Cliente", dbVar: "client_segment", icon: User },
    ],
    "Datos del Contrato": [
      ...
      { label: "Próx. Facturación", dbVar: "next_billing_date", icon: Calendar },
      { label: "Estado Contrato", dbVar: "contract_status", icon: FileText },
      { label: "Estado Pago", dbVar: "payment_status", icon: DollarSign },
      { label: "Fecha Creación", dbVar: "created_at", icon: Calendar },
    ],
    "Importes": [
    ...
    "Servicios (Lista)": [
      ...
      { label: "Descripción Servicio", dbVar: "service_description", icon: FileText },
      { label: "Categoría Servicio", dbVar: "service_category", icon: FileSpreadsheet },
      { label: "Precio Servicio", dbVar: "service_price", icon: DollarSign },
      { label: "Cantidad", dbVar: "quantity", icon: Hash },
      { label: "Descuento %", dbVar: "discount_percent", icon: DollarSign },
      { label: "Descuento €", dbVar: "discount_amount", icon: DollarSign },
      { label: "IVA %", dbVar: "line_iva_percent", icon: DollarSign },
      { label: "IVA €", dbVar: "line_iva_amount", icon: DollarSign },
      { label: "Subtotal Línea", dbVar: "line_subtotal", icon: DollarSign },
      { label: "Total Línea", dbVar: "line_total", icon: DollarSign },
    ],
    "Otros": [
      { label: "Notas", dbVar: "notes", icon: FileText },
      { label: "URL Documento", dbVar: "document_url", icon: FileText },
      { label: "Fecha Actual", dbVar: "current_date", icon: Calendar },
    ],
  },
  invoice: {
    "Datos de Empresa": [
    ...
    "Datos de Factura": [
      ...
      { label: "Estado Factura", dbVar: "invoice_status", icon: FileText },
      { label: "Nº Contrato", dbVar: "contract_number", icon: Hash },
      { label: "Nombre Contrato", dbVar: "contract_name", icon: FileText },
    ],
    "Importes": [
    ...
    "Servicios (Lista)": [
      { label: "Nombre Servicio", dbVar: "service_name", icon: FileSpreadsheet },
      { label: "Descripción", dbVar: "service_description", icon: FileText },
      { label: "Cantidad", dbVar: "quantity", icon: Hash },
  ...
  quote: {
    ...
    "Datos del Cliente/Contacto": [
      ...
      { label: "Provincia Cliente", dbVar: "client_province", icon: Building2 },
      { label: "CP Cliente", dbVar: "client_postal_code", icon: Hash },
      { label: "Nombre Contacto", dbVar: "contact_name", icon: User },
      { label: "Email Contacto", dbVar: "contact_email", icon: User },
      { label: "Teléfono Contacto", dbVar: "contact_phone", icon: User },
    ],
    "Datos del Presupuesto": [
      ...
      { label: "Estado", dbVar: "quote_status", icon: FileText },
    ],
    "Importes": [
      { label: "Subtotal", dbVar: "subtotal", icon: DollarSign },
      { label: "% IVA", dbVar: "iva_percent", icon: DollarSign },
    ...
    "Servicios (Lista)": [
      { label: "Nombre Servicio", dbVar: "service_name", icon: FileSpreadsheet },
      { label: "Descripción", dbVar: "service_description", icon: FileText },
      { label: "Categoría", dbVar: "service_category", icon: FileSpreadsheet },
      { label: "Cantidad", dbVar: "quantity", icon: Hash },
      { label: "Precio Unitario", dbVar: "unit_price", icon: DollarSign },
      { label: "Descuento %", dbVar: "discount_percent", icon: DollarSign },
      { label: "Descuento €", dbVar: "discount_amount", icon: DollarSign },
